...
class Pluralizer
{
	...
	/**
     * Instancia del InflectorFactory
     *
     * @var static
     */
     ...
     * @var string
     */
    protected static $language = Language::ENGLISH;
    ...
    /**
     * Obtiene la instancia de Doctrine/Inflector
     *
    ...
    {
        return static::inflector()->unaccent($value);
    }
